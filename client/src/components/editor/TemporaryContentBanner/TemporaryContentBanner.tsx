...
export function TemporaryContentBanner() {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 bg-accent-amber/20 border-b border-accent-amber/30 text-accent-amber text-xs font-medium select-none">
      <span>
